#ifndef HEAP_ALLOCATION_POLICY_HPP
#define HEAP_ALLOCATION_POLICY_HPP
...
namespace Forge {
	class HeapAllocationPolicy : public IAllocationPolicy
	{
	public:
		/**
...
#include "../../../Private/Memory/Policies/HeapAllocationPolicy_inl.hpp"
